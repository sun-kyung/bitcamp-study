...
// 다음 태그를 붙여야한다
// 단, 이 클래스가 @ComponentScan에서 지정한 패키지 안에 있어야한다
@Configuration
...
// Spring IoC컨테이너에서 사용할 Properties 파일을 로딩하기
@PropertySource("classpath:com/eomcs/lms/conf/jdbc.properties")
public class DatabaseConfig {

  static Logger logger = LogManager.getLogger(DatabaseConfig.class);

  // @PropertySource로 로딩한 .properties파일의 값을 사용하고 싶다면
  ...
  public PlatformTransactionManager transactionMaanger(DataSource dataSource) {
