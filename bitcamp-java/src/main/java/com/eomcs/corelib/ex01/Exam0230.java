...
public class Exam0230 {
  public static void main(String[] args) {
    ...
    // => new 연산자를 통해 Integer객체를 생성하면 Heap에 인스턴스를 생성한다
    ...
    // => 같은 값을 가지는 Integer객체가 여러 개 존재해야 할 필요가 없다
    ...
    //다음과 같이 auto-boxing으로 생성된 객체와 valueOf()가 리턴한 객체를 비교해보자
    System.out.println(obj3 == obj6);
