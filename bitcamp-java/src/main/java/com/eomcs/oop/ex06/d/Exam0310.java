...
public class Exam0310 {
  ...
  public static void main(String[] args) {
    ...
    // => == 연산자와 동일하게 동작한다
    // => 이 메서드 또한 Object에 정의된 메서드이기 대문에 자바의 모든 클래스는 이 메서드를 사용할 수 있다

    System.out.println(m1.equals(m2));
    
    // m1과 m2는 다른 인스턴스이기때문에 결과는 당연히 false이다
    ...
    // 그런데 위의 실행 결과를 보면 m1과 m2가 서로 다른 인스턴스인데도 불구하고
    // true를 리턴한다
    // 이유?
    ...
    // Member 객체에 대해서도 인스턴스가 다르더라도 데이터가 같으면 true를 리턴하도록 하고싶은가?
