...
public class Exam0111 {
  ...
  public static void main(String[] args) {
    ...
    // => 하위 클래스의 인스턴스는 상위 클래스의 인스턴스 멤버를 갖고있기 때문이다
    // => 그래서 상위 클래스의 레퍼런스로 상위 클래스의 인스턴스 멤버를 사용을 보장한다
    
    // Vehicle 변수 v2가 Bike 객체를 가리킨다면
    v2 = b;
    
    // v2를ㄹ 통해 Vehicle 의 인스턴스 변수를 접근할 수 있다
    v2.model = "티코";
    v2.capacity = 5;
    
    // =>Bike 인스턴스에는 수퍼클래스인 Vehicle의 인스턴스 변수가 있기 때문이다
