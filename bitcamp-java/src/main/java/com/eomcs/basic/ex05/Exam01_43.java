...
public class Exam01_43 {
  public static void main(String[] args) {
    ...
    // 결과값: 987.6543 + 1.111111 = 988.7654
    ...
    // 4바이트 float 부동소수점을 8바이트 double 부동소수점 변수에 저장할 때 왜곡된 값이 들어갈 수 있다
    // float을 double 변수에 넣을 때 왜곡이 발생하기 때문에 가능한 double 변수로 값을 바꾼 다음 연산 수행
