...
public class Exam33 {
  public static void main(String[] args) {
    ...
    //    숫자의 개수가 7개이면 거의 정상적으로 저장하고 꺼낼 수 있다
    //    이렇게 정상적으로 넣고 꺼낼 수 있는 부동소수점의 숫자 개수를 "유효자릿수"라고 부름
    // => 주의! : 7자리라 하더라도 값이 구겨질 수 있다 (정상적으로 저장되지 않을 수 있다)
    //    그래서 부동소수점은 메모리에서 꺼낸 값을 내부의 규칙에 따라 JVM이 보정해준다.
    // => 100% 정확하게 저장되고 꺼내지 못하는 이유는
    //    부동소수점을 2진수로 바꿀 때 IEEE754 규칙에 따라 변경하는데,
