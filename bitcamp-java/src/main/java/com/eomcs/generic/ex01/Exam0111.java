...
public class Exam0111 {
  ...
  // 인스턴스의 변수타입을 Object 로 선언한다
  // => 그러면 다음과 같이 한 개의 Box클래스만 선언하면 된다
  ...
  public static void main(String[] args) {
    ...
    int i = (Integer) box3.get(); // 값을 꺼낼 때 primitive data type을 지정하면
                                  // 자동으로 auto-unboxing으로 바꾼다
    System.out.println(i);
    
    // 객체의 타입별로 Box클래스를 구분해서 쓰지 않으니 코딩이 편하다
    // 단 값을 꺼낼 때 원래 타입으로 바꾸기 위해 형변환(type casting)해야하는 불편함이 있다
